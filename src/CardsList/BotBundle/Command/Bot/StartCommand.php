    ...
    public function execute()
    {
        ...
        $data = [
            ...
            'text' => 'Сохраняйте кредитные карты и удобно пересылайте их друзьям!'.PHP_EOL.PHP_EOL.
                '➡️ Отправьте мне номер карты, чтобы сохранить её.'.PHP_EOL.PHP_EOL.
                '‼️ Ваши данные не будут переданы третьим лицам.'.PHP_EOL.PHP_EOL.
                '👉 /'.ListCommand::NAME.' - посмотреть список сохраненных карт.'.PHP_EOL.PHP_EOL.
                'Чтобы быстро отправить карту со своего списка - просто напишите в чате @'.$this->telegram->getBotUsername().
                ' и имя владельца карты.',
        ];
